...
需要二维的boolean数组辅助，空间复杂度O(n ^ 2)

> 总结

Runtime: 6 ms, faster than 99.47% of Java online submissions for Trapping Rain Water II.

Memory Usage: 39.6 MB, less than 29.36% of Java online submissions for Trapping Rain Water II.
